"""
Django settings for noisy_grass_42803 project.
...
ROOT_URLCONF = 'noisy_grass_42803.urls'
...
WSGI_APPLICATION = 'noisy_grass_42803.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "noisy_grass_42803 API",
    "DESCRIPTION": "API documentation for noisy_grass_42803 App",
    "VERSION": "v1",
}
